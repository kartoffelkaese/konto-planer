            ...
            <form id="general-settings" onSubmit={handleSubmit} className="rounded-lg shadow-md p-4 bg-white dark:bg-dark-light">
              ...
              <div className="space-y-6">
                ...
                <div className="flex justify-end">
                  <button
                    type="submit"
                    className="cursor-pointer px-4 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 rounded-md disabled:opacity-50 disabled:cursor-not-allowed"
                    disabled={loading}
                  >
              ...
              {!showEmailForm ? (
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="cursor-pointer px-4 py-2 text-sm font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300"
                  >
                    Ändern
                  </button>
                </div>
                ...
                <form onSubmit={handleEmailChange} className="space-y-4">
                  ...
                  <div className="flex justify-end space-x-3">
                    <button
                      ...
                      className="cursor-pointer px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700"
                    >
                      Abbrechen
                    </button>
                    <button
                      type="submit"
                      className="cursor-pointer px-4 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 rounded-md shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                      disabled={emailLoading}
                    >
